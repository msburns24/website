...
image: notebook_vs_production.svg
include-before-body:
  text: '<img src="notebook_vs_production.svg" style="width:100%; margin-bottom:1rem;">'
categories:
  - Machine Learning
  - ML Engineering
...
<div class="repo-card">
  ...
  <p class="repo-desc">Production-ready sentiment classifier on 130M Amazon reviews — fallback chain, drift detection,
    FastAPI serving, and Streamlit observability dashboard.</p>
  <div class="repo-tags">
